        ...
        <div>
          ...
          <Reveal delay={0.08}>
            <h2 className="heading-lg mt-5">
              Dúvidas respondidas{" "}
              <span className="text-teal-deep">sem enrolação.</span>
            </h2>
          </Reveal>
          <Reveal delay={0.16}>
          ...
          <Reveal delay={0.24}>
            <a
              ...
              target="_blank"
              rel="noopener"
              className="mt-6 inline-flex items-center gap-2 border-b-2 border-teal pb-1 font-display text-sm font-bold uppercase tracking-wider text-teal-deep transition-all hover:gap-4"
            >
              Falar com a Cliqmed
          ...
          {FAQS.map((f, i) => {
            ...
            return (
              <Reveal key={f.q} delay={i * 0.05}>
                <div
                  className={`card overflow-hidden transition-colors ${open ? "border-teal/40" : ""}`}
                >
                  <button
                  ...
                  >
                    ...
                    <span
                      className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full transition-all duration-300 ${
                        open ? "rotate-45 bg-teal text-white" : "bg-teal/10 text-teal-deep"
                      }`}
                    >
